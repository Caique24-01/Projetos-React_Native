...
import { Modal, View, Text, TextInput, TouchableOpacity, StyleSheet, ScrollView, AsyncStorage } from "react-native"
import { adicionaNota } from "../services/Nota"
...
export default function NotaEditor({ mostraNotas, notaSelecionada, setNotaSelecionada }) {
  ...
  async function salvaNota() {
    ...
    //await AsyncStorageLib.setItem(umaNota.id, JSON.stringify())
    mostraNotas()
    limpaModal()
  }
